                    ...
                    <div className="lg:px-16 md:px-4 sm:px-10">
                        ...
                        <div className="flex-center">
                            <ol className="relative border-s border-gray-200 dark:border-gray-700 sm:pr-10 pr-10">
                                {ExperienceList.map(({ company, role, location, link, fromDate, toDate, description, skillTags }, index) => (
                                    <a key={index} href={link} target="_blank">
                                        <li className={`cursor-pointer w-full rounded bg-zinc hover:bg-gray-800 px-4 py-2 ms-6 ${(index == ExperienceList.length - 1) ? "mb-1" : "mb-5"}`}>
                                            ...
                                            <time className="flex flex-wrap items-center text-sm font-normal leading-none text-gray-500">
                                                <span>{company}</span>
