...
const Tech = () => {
    ...
    const onTabClick = (index) => setCurrentTab(index);

    return (
        <ErrorBoundary fallback={<p>Something went wrong</p>}>
            <div id="Tech" className="w-full h-full p-3 rounded-xl shadow sm:py-6 border-gray-200 dark:border-gray-700 bg-black">
                ...
                <div className="mb-0">
                    <ul className="tech-section text-sm font-medium text-left whitespace-nowrap overflow-x-auto overflow-y-hidden no-scrollbar"
                ...
                <div id="default-tab-content" className="max-md:h-[350px] overflow-x-hidden overflow-y-auto">
                    {
                        Object.keys(techList).map((type, index) => {
                            let str = type.replace(/\s+/g, '');
                            ...
                            return (
                                ...
                                >
                                    <div className="gap-10 grid sm:grid-cols-1 max-md:grid-cols-1 md:grid-cols-2 lg:grid-cols-2">
                                        {
                                            arr.map(({ tech, expertise }) => (
                                                <div key={tech}>
                                                    ...
                                                    <div className="w-full rounded-full h-2.5">
                                                        <div className="bg-white h-1.5 rounded-full" style={{ width: `${expertise}%` }} role='progressbar' ></div>
                                                    </div>
                                                </div>
                                            ))
                                        }
