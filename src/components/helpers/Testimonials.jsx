...
import { G_Surendar_Thina, Saiyasodharan_R, saravanan_mani } from '../../utils';
...
const Testimonials = () => {
    ...
    const testimonialList = [
        ...
        },
        {
            ...
            position: "Front end/Bitcoin developer",
            date: "April 2, 2019",
            image: Saiyasodharan_R,
    ...
    return (
        <ErrorBoundary fallback={<p>Something went wrong</p>}>
            <div id="Testimonials" className="w-full h-full p-4 rounded-xl shadow sm:p-6 border-gray-200 dark:border-gray-700 bg-black">
